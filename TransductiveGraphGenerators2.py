...
from GNN.Generators.GraphGenerators import MultiGraphGenerator, SingleGraphGenerator, CompositeMultiGraphGenerator, CompositeSingleGraphGenerator


#######################################################################################################################
### CLASS GRAPH GENERATORS FOR MULTIPLE HETEROGENEOUS DATA ### FOR FEEDING THE MODEL DURING LEARNING PROCESS ##########
#######################################################################################################################
class MultiTransductiveGraphGenerator(CompositeMultiGraphGenerator):
...
#######################################################################################################################
class SingleTransductiveGraphGenerator(MultiTransductiveGraphGenerator, CompositeSingleGraphGenerator):
    def __init__(self,
                 graph: GraphObject,
                 problem_based: str,
                 transductive_rate: float = 0.5,
